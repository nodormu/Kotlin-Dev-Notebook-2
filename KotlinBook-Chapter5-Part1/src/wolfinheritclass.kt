...
class wolfinheritclass(override val nameofanimal: String = "wolf", override val food: String = "rabbits", override val image : String = "src/wolf.jpg", override val habitat : String = "forest") : animalssuperclass () {
    override fun makeNoise (){
        println("Hooooowwwwwwlll!")
    }
    override fun eat(){
